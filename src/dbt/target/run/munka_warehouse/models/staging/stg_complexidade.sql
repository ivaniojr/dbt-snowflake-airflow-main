  ...
  create or replace   view GIRAFFE_DB.munka_stg.stg_complexidade
...
(
    ...
    "PONTUACAO_MAIOR_QUE" COMMENT $$$$, 
  
    "PONTUACAO_MENOR_QUE" COMMENT $$$$, 
   ...
   as (
    ...
    DW_INGESTED_AT,
    DW_ROW_HASH
FROM GIRAFFE_DB.MUNKA_RAW.RAW_COMPLEXIDADE
