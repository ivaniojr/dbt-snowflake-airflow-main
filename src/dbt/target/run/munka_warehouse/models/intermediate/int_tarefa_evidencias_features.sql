...
(
    ...
    "FL_ENVOLVE_FRONTEND" COMMENT $$$$, 
  
    "FL_ENVOLVE_BACKEND" COMMENT $$$$, 
  
    "FL_ENVOLVE_DADOS" COMMENT $$$$, 
  
    "FL_IS_BUGFIX" COMMENT $$$$, 
  
    "QTD_BLOCOS_CODIGO" COMMENT $$$$, 
  
    "FL_TEM_PULL_REQUEST" COMMENT $$$$, 
  
    "TAMANHO_TEXTO" COMMENT $$$$, 
  
    "SCORE_QUALIDADE_EVIDENCIA" COMMENT $$$$
